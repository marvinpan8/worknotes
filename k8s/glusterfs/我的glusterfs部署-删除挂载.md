...
| 操作系统   | IP             | 主机名        | 硬盘数量（三块）    |
| ---------- | -------------- | ------------- | ------------------- |
| centos 7.6 | 192.168.10.113 | vmsrv-010-113 | sda:100G  sdb:500G  |
| centos 7.6 | 192.168.10.122 | vmsrv-010-122 | sda:100G  sdb:500G  |
| centos 7.6 | 192.168.10.123 | vmsrv-010-123 | ssda:100G  sdb:500G |
| centos 7.6 | 192.168.10.221 | vmsrv-010-221 | sda:100G  sdb:500G  |
| centos 7.6 | 192.168.10.124 | vmsrv-010-124 | sda:100G            |

### 首先关闭iptables和selinux，配置hosts文件如下（全部glusterfs主机）

```bash
[root@vmsrv-010-113 ~]# cat /etc/hosts
...
### 安装gluterfs源（全部glusterfs主机）

```bash
[root@vmsrv-010-124 yum.repos.d]# yum search  centos-release-gluster
...
### 查看glusterfs版本并启动glusterfs服务(全部glusterfs主机)
...
[root@vmsrv-010-113 ~]# netstat -lntup |grep gluster
tcp        0      0 0.0.0.0:49152           0.0.0.0:*               LISTEN      23713/glusterfsd    
tcp        0      0 0.0.0.0:24007           0.0.0.0:*               LISTEN      20642/glusterd  
```
