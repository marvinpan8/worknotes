...
- [Redis高可用详解：持久化技术及方案选择](http://mp.weixin.qq.com/s?__biz=MzI4NTA1MDEwNg==&mid=2650769300&idx=1&sn=49a11efa1a6ee605fceaddf240a55c40&chksm=f3f93201c48ebb175fa76053d95e315b621485b0e65e42d8b41fe91b8f859c9278f3adec7ca9&scene=21#wechat_redirect)
...
![img](http://www.redis.cn/images/articles/20181020001_001.webp)
...
redis-server redis-6380.confbash
redis-server redis-6381.conf
```

节点启动后，连接主节点查看主从状态是否正常，如下图所示：

![img](http://www.redis.cn/images/articles/20181020001_002.webp)
...
其中，`sentinel monitor mymaster 192.168.92.128 6379 2` 配置的含义是：该哨兵节点监控192.168.92.128:6379 这个主节点，该主节点的名称是 mymaster，最后的2的含义与主节点的故障判定有关：至少需要2个哨兵节点同意，才能判定主节点故障并进行故障转移。
...
![img](http://www.redis.cn/images/articles/20181020001_003.webp)

此时如果查看哨兵节点的配置文件，会发现一些变化，以26379为例：

![img](http://www.redis.cn/images/articles/20181020001_004.webp)
...
![img](http://www.redis.cn/images/articles/20181020001_005.webp)

**Step2：**如果此时立即在哨兵节点中使用info Sentinel命令查看，会发现主节点还没有切换过来，因为哨兵发现主节点故障并转移，需要一段时间。

![img](http://www.redis.cn/images/articles/20181020001_006.webp)

**Step3：**一段时间以后，再次在哨兵节点中执行info Sentinel查看，发现主节点已经切换成6380节点。

![img](http://www.redis.cn/images/articles/20181020001_007.webp)
...
![img](http://www.redis.cn/images/articles/20181020001_008.webp)
...
![img](http://www.redis.cn/images/articles/20181020001_009.webp)
...
![img](http://www.redis.cn/images/articles/20181020001_010.webp)
...
![img](http://www.redis.cn/images/articles/20181020001_011.webp)
